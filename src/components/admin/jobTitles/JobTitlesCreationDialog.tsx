...
interface JobTitleCreationDialogProps {
  open: boolean;
  onClose: () => void;
  refreshData: () => void;
...
const JobTitleCreationDialog: React.FC<JobTitleCreationDialogProps> = ({
  open,
  onClose,
  refreshData,
  departments,
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!jobTitleName || selectedDepartment === "") {
      showSnackbar("Please provide all required fields.", "warning");
      return;
    }
    ...
    try {
      ...
      showSnackbar("Job title created successfully", "success");
      handleClose();
      refreshData();
    } catch (err) {
      console.error("Error creating job title:", err);
      showSnackbar("Error creating job title", "error");
    } finally {
      setLoading(false);
    }
  };
...
export default JobTitleCreationDialog;
